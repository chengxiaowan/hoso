var config = {
	...
	api_list: api_url + '/coupon/couponGoodsList', //获取节日活动商品列表
	...
	api_add: api_url + '/coupon/addCouponGoods', //新增活动商品
	api_del: api_url + '/coupon/delCouponGoods', //删除活动商品
	api_check: api_url + '/coupon/checkCouponGoods', //检验是否加入
	//	api_editInfo: api_url + '/activity/editActivityGoodsInfo', //修改时获取信息
	//	api_edit: api_url + '/activity/editActivityGoods', //修改
	id: parameter().id
}
