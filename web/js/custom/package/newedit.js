var config = {
    ...
    api_info: api_url + '/memPackage/detail'
}
            ...
            $.ajax({
                ...
                success: res => {
                    if (res.error == "00") {
                        ...
                        that.msprice = drool.monthPrice;    //包月售价
                        that.mfprice = drool.mfirstPrice;     //包月首冲

                        that.dprice = drool.oldquarterprice;      //包季度原价
                        that.dsprice = drool.quarterPrice;   //包季度售价
                        that.dfprice = drool.qfirstPrice;    //包季度首冲
