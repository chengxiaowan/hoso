...
function uploaderReady3(token){
    ...
    var uploader3 = Qiniu3.uploader({
        runtimes: 'html5,flash,html4',
        browse_button: 'pickfiles3',     //上传按钮的ID
...
function uploaderReady4(token){
    ...
    var uploader4 = Qiniu4.uploader({
        runtimes: 'html5,flash,html4',
        browse_button: 'pickfiles4',     //上传按钮的ID
        container: 'btn-uploader4',      //上传按钮的上级元素ID
        drop_element: 'btn-uploader',
        max_file_size: '100mb',         //最大文件限制
        flash_swf_url: '/static/js/plupload/Moxie.swf',
        dragdrop: false,
...
function uploaderReady5(token){
    ...
    var uploader5 = Qiniu5.uploader({
        runtimes: 'html5,flash,html4',
        browse_button: 'pickfiles5',     //上传按钮的ID
        container: 'btn-uploader5',      //上传按钮的上级元素ID
        drop_element: 'btn-uploader',
        max_file_size: '100mb',         //最大文件限制
        flash_swf_url: '/static/js/plupload/Moxie.swf',
        dragdrop: false,
...
function uploaderReady6(token){
    ...
    var uploader6 = Qiniu6.uploader({
        runtimes: 'html5,flash,html4',
        browse_button: 'pickfiles6',     //上传按钮的ID
        container: 'btn-uploader6',      //上传按钮的上级元素ID
        drop_element: 'btn-uploader',
        max_file_size: '100mb',         //最大文件限制
        flash_swf_url: '/static/js/plupload/Moxie.swf',
        dragdrop: false,
...
function uploaderReady7(token,goodsPicList) {
		var uploader7 = Qiniu7.uploader({
			runtimes: 'html5,flash,html4',
			browse_button: 'pickfiles7', //上传按钮的ID
			container: 'btn-uploader7', //上传按钮的上级元素ID
			drop_element: 'btn-uploader',
			max_file_size: '100mb', //最大文件限制
			flash_swf_url: '/static/js/plupload/Moxie.swf',
			dragdrop: false,
