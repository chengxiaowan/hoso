var config = {
    ...
    api_list: api_url+'/service/getPhotoStudioListPage', //获取联系人列表
    api_add: api_url+'/service/saveOrupdate', //新增联系人
    api_view: api_url+'/service/saveOrupdate', //编辑联系人
    api_del: api_url+'/service/deletePhotoStudioById', //删除联系人
}
window.app = new Vue({
    el: '#app',
    data: {
