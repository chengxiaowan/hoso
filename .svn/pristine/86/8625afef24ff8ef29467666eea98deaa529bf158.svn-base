var config = {
	...
	api_list: api_url + '/hot/hotSceneList', //获取热门商品列表
	api_add: api_url + '/hot/addHotScene', //添加热门场景
	api_edit: api_url + '/hot/editHotScene', //编辑热门场景
	api_info: api_url + '/hot/editHotSceneInfo', //获取热门场景信息
	api_del: api_url + '/hot/delHotScene', // 删除热门场景
