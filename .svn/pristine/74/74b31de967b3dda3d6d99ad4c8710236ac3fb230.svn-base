var config = {
	...
	api_list: api_url + '/distribution/distributorList', //获取销售人员列表
	api_add: api_url + '/distribution/addDistributor', //新增销售人员
	api_edit: api_url + '/distribution/editDistributor', //修改标签
	api_del: api_url + '/distribution/delDistributor', //删除分销人员
	api_info: api_url + '/distribution/editDistorbutorInfo', //获取销售人员详情
}
window.app = new Vue({
	el: '#app',
	data: {
